...
export class ZUGFeRDEmbedder {
   ...
   */
  async embedZugferdXml(pdfBuffer: Buffer, xmlContent: string): Promise<Buffer> {
  ...
  private async embedXmlAsAttachment(pdfDoc: PDFDocument, xmlContent: string): Promise<void> {
